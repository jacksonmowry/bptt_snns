 ...
 *
 * The interface is contained with a single C++ header file \em opencl.hpp and
 all
    ...
    int main(void)
    {
        ...
        for (auto &p : platforms) {
            ...
            if (platver.find("OpenCL 2.") != std::string::npos ||
                ...
                // Note: an OpenCL 3.x platform may not support all required
 features! plat = p;
            }
        }
        if (plat() == 0) {
        ...
        std::string kernel2{R"CLC(
            ...
            kernel void vectorAdd(global const Foo* aNum, global const int
 *inputA, global const int *inputB, global int *output, int val, write_only pipe
 ...
 inputB[get_global_size(0)*3 + get_global_id(0)] + globalA + 2;
                });
            }
        )CLC"};
 ...
 svmAllocReadOnly; auto fooPointer =
...
#pragma message(                                                               \
    "opencl.hpp: USE_DX_INTEROP is deprecated. Define CL_HPP_USE_DX_INTEROP instead")
#define CL_HPP_USE_DX_INTEROP
#endif
...
#pragma message(                                                               \
    "opencl.hpp: __NO_STD_VECTOR is deprecated. Define CL_HPP_NO_STD_VECTOR instead")
#define CL_HPP_NO_STD_VECTOR
#endif
#if !defined(CL_HPP_NO_STD_STRING) && defined(__NO_STD_STRING)
#pragma message(                                                               \
    "opencl.hpp: __NO_STD_STRING is deprecated. Define CL_HPP_NO_STD_STRING instead")
#define CL_HPP_NO_STD_STRING
#endif
#if defined(VECTOR_CLASS)
#pragma message(                                                               \
    "opencl.hpp: VECTOR_CLASS is deprecated. Alias cl::vector instead")
#endif
#if defined(STRING_CLASS)
#pragma message(                                                               \
    "opencl.hpp: STRING_CLASS is deprecated. Alias cl::string instead.")
#endif
...
#pragma message(                                                               \
    "opencl.hpp: __USE_DEV_VECTOR is no longer supported. Expect compilation errors")
#endif
#if defined(__USE_DEV_STRING)
#pragma message(                                                               \
    "opencl.hpp: __USE_DEV_STRING is no longer supported. Expect compilation errors")
#endif
...
#endif
#if CL_HPP_MINIMUM_OPENCL_VERSION <= 210 &&                                    \
    !defined(CL_USE_DEPRECATED_OPENCL_2_1_APIS)
#define CL_USE_DEPRECATED_OPENCL_2_1_APIS
#endif
#if CL_HPP_MINIMUM_OPENCL_VERSION <= 220 &&                                    \
...
class Error : public std::exception {
  ...
  public:
     ...
     */
    Error(cl_int err, const char* errStr = nullptr)
...
#else
#define __GET_KERNEL_SUB_GROUP_INFO_ERR                                        \
    CL_HPP_ERR_STR_(clGetKernelSubGroupInfoKHR)
...
#define __SET_CONTEXT_DESCTRUCTOR_CALLBACK_ERR                                 \
...
#define __SET_DEFAULT_DEVICE_COMMAND_QUEUE_ERR                                 \
    CL_HPP_ERR_STR_(clSetDefaultDeviceCommandQueue)
#endif // CL_HPP_TARGET_OPENCL_VERSION >= 210
...
#define __SET_PROGRAM_RELEASE_CALLBACK_ERR                                     \
    CL_HPP_ERR_STR_(clSetProgramReleaseCallback)
#define __SET_PROGRAM_SPECIALIZATION_CONSTANT_ERR                              \
    CL_HPP_ERR_STR_(clSetProgramSpecializationConstant)
#endif

#ifdef cl_khr_external_memory
#define __ENQUEUE_ACQUIRE_EXTERNAL_MEMORY_ERR                                  \
    CL_HPP_ERR_STR_(clEnqueueAcquireExternalMemObjectsKHR)
#define __ENQUEUE_RELEASE_EXTERNAL_MEMORY_ERR                                  \
    CL_HPP_ERR_STR_(clEnqueueReleaseExternalMemObjectsKHR)
#endif
...
#define __ENQUEUE_WAIT_SEMAPHORE_KHR_ERR                                       \
    CL_HPP_ERR_STR_(clEnqueueWaitSemaphoresKHR)
#define __ENQUEUE_SIGNAL_SEMAPHORE_KHR_ERR                                     \
    CL_HPP_ERR_STR_(clEnqueueSignalSemaphoresKHR)
...
#define __GET_SEMAPHORE_HANDLE_FOR_TYPE_KHR_ERR                                \
    CL_HPP_ERR_STR_(clGetSemaphoreHandleForTypeKHR)
#endif // cl_khr_external_semaphore

#if defined(cl_khr_command_buffer)
#define __CREATE_COMMAND_BUFFER_KHR_ERR                                        \
    CL_HPP_ERR_STR_(clCreateCommandBufferKHR)
#define __GET_COMMAND_BUFFER_INFO_KHR_ERR                                      \
    CL_HPP_ERR_STR_(clGetCommandBufferInfoKHR)
#define __FINALIZE_COMMAND_BUFFER_KHR_ERR                                      \
    CL_HPP_ERR_STR_(clFinalizeCommandBufferKHR)
#define __ENQUEUE_COMMAND_BUFFER_KHR_ERR                                       \
    CL_HPP_ERR_STR_(clEnqueueCommandBufferKHR)
#define __COMMAND_BARRIER_WITH_WAIT_LIST_KHR_ERR                               \
    CL_HPP_ERR_STR_(clCommandBarrierWithWaitListKHR)
#define __COMMAND_COPY_BUFFER_KHR_ERR CL_HPP_ERR_STR_(clCommandCopyBufferKHR)
#define __COMMAND_COPY_BUFFER_RECT_KHR_ERR                                     \
    CL_HPP_ERR_STR_(clCommandCopyBufferRectKHR)
#define __COMMAND_COPY_BUFFER_TO_IMAGE_KHR_ERR                                 \
    CL_HPP_ERR_STR_(clCommandCopyBufferToImageKHR)
#define __COMMAND_COPY_IMAGE_KHR_ERR CL_HPP_ERR_STR_(clCommandCopyImageKHR)
#define __COMMAND_COPY_IMAGE_TO_BUFFER_KHR_ERR                                 \
    CL_HPP_ERR_STR_(clCommandCopyImageToBufferKHR)
...
#define __COMMAND_NDRANGE_KERNEL_KHR_ERR                                       \
    CL_HPP_ERR_STR_(clCommandNDRangeKernelKHR)
#define __UPDATE_MUTABLE_COMMANDS_KHR_ERR                                      \
    CL_HPP_ERR_STR_(clUpdateMutableCommandsKHR)
#define __GET_MUTABLE_COMMAND_INFO_KHR_ERR                                     \
    CL_HPP_ERR_STR_(clGetMutableCommandInfoKHR)
#define __RETAIN_COMMAND_BUFFER_KHR_ERR                                        \
    CL_HPP_ERR_STR_(clRetainCommandBufferKHR)
#define __RELEASE_COMMAND_BUFFER_KHR_ERR                                       \
    CL_HPP_ERR_STR_(clReleaseCommandBufferKHR)
#endif // cl_khr_command_buffer

#if defined(cl_ext_image_requirements_info)
#define __GET_IMAGE_REQUIREMENT_INFO_EXT_ERR                                   \
    CL_HPP_ERR_STR_(clGetImageRequirementsInfoEXT)
...
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clReleaseSemaphoreKHR
    pfn_clReleaseSemaphoreKHR = nullptr;
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clRetainSemaphoreKHR pfn_clRetainSemaphoreKHR =
    nullptr;
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clEnqueueWaitSemaphoresKHR
    pfn_clEnqueueWaitSemaphoresKHR = nullptr;
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clEnqueueSignalSemaphoresKHR
    pfn_clEnqueueSignalSemaphoresKHR = nullptr;
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clGetSemaphoreInfoKHR
...
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clGetSemaphoreHandleForTypeKHR
...
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clCreateCommandBufferKHR
    pfn_clCreateCommandBufferKHR = nullptr;
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clFinalizeCommandBufferKHR
    pfn_clFinalizeCommandBufferKHR = nullptr;
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clRetainCommandBufferKHR
    pfn_clRetainCommandBufferKHR = nullptr;
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clReleaseCommandBufferKHR
    pfn_clReleaseCommandBufferKHR = nullptr;
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clGetCommandBufferInfoKHR
    pfn_clGetCommandBufferInfoKHR = nullptr;
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clEnqueueCommandBufferKHR
...
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clCommandCopyBufferKHR
    pfn_clCommandCopyBufferKHR = nullptr;
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clCommandCopyBufferRectKHR
    pfn_clCommandCopyBufferRectKHR = nullptr;
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clCommandCopyBufferToImageKHR
    pfn_clCommandCopyBufferToImageKHR = nullptr;
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clCommandCopyImageKHR
    pfn_clCommandCopyImageKHR = nullptr;
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clCommandCopyImageToBufferKHR
    pfn_clCommandCopyImageToBufferKHR = nullptr;
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clCommandFillBufferKHR
    pfn_clCommandFillBufferKHR = nullptr;
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clCommandFillImageKHR
    pfn_clCommandFillImageKHR = nullptr;
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clCommandNDRangeKernelKHR
...
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clUpdateMutableCommandsKHR
    pfn_clUpdateMutableCommandsKHR = nullptr;
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clGetMutableCommandInfoKHR
    pfn_clGetMutableCommandInfoKHR = nullptr;
#endif /* cl_khr_command_buffer_mutable_dispatch */

#if defined(cl_ext_image_requirements_info)
CL_HPP_CREATE_CL_EXT_FCN_PTR_ALIAS_(clGetImageRequirementsInfoEXT);
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clGetImageRequirementsInfoEXT
    pfn_clGetImageRequirementsInfoEXT = nullptr;
#endif
...
inline cl_int getInfoHelper(Func f, cl_uint name,
    ...
    if (param) {
        // Create array of pointers, calculate total size and pass pointer array
        // in
...
#define CL_HPP_PARAM_NAME_INFO_1_2_(F)                                         \
    ...
    F(cl_kernel_arg_info, CL_KERNEL_ARG_TYPE_QUALIFIER,                        \
      cl_kernel_arg_type_qualifier)                                            \
                                                                               \
    F(cl_kernel_work_group_info, CL_KERNEL_GLOBAL_WORK_SIZE,                   \
      cl::detail::size_t_array)                                                \
                                                                               \
...
#define CL_HPP_PARAM_NAME_INFO_2_0_(F)                                         \
    ...
    F(cl_device_info, CL_DEVICE_GLOBAL_VARIABLE_PREFERRED_TOTAL_SIZE,          \
      size_type)                                                               \
...
#define CL_HPP_PARAM_NAME_INFO_SUBGROUP_KHR_(F)                                \
    F(cl_kernel_sub_group_info, CL_KERNEL_MAX_SUB_GROUP_SIZE_FOR_NDRANGE_KHR,  \
      size_type)                                                               \
    F(cl_kernel_sub_group_info, CL_KERNEL_SUB_GROUP_COUNT_FOR_NDRANGE_KHR,     \
      size_type)
...
#define CL_HPP_PARAM_NAME_INFO_2_1_(F)                                         \
    ...
    F(cl_device_info, CL_DEVICE_SUB_GROUP_INDEPENDENT_FORWARD_PROGRESS,        \
      cl_bool)                                                                 \
    F(cl_command_queue_info, CL_QUEUE_DEVICE_DEFAULT, cl::DeviceCommandQueue)  \
    F(cl_kernel_sub_group_info, CL_KERNEL_MAX_SUB_GROUP_SIZE_FOR_NDRANGE,      \
      size_type)                                                               \
    F(cl_kernel_sub_group_info, CL_KERNEL_SUB_GROUP_COUNT_FOR_NDRANGE,         \
      size_type)                                                               \
...
#define CL_HPP_PARAM_NAME_CL_KHR_EXTENDED_VERSIONING_CL3_SHARED_(F)            \
    ...
    F(cl_platform_info, CL_PLATFORM_EXTENSIONS_WITH_VERSION_KHR,               \
      cl::vector<cl_name_version_khr>)                                         \
                                                                               \
    F(cl_device_info, CL_DEVICE_NUMERIC_VERSION_KHR, cl_version_khr)           \
    F(cl_device_info, CL_DEVICE_EXTENSIONS_WITH_VERSION_KHR,                   \
      cl::vector<cl_name_version_khr>)                                         \
    F(cl_device_info, CL_DEVICE_ILS_WITH_VERSION_KHR,                          \
      cl::vector<cl_name_version_khr>)                                         \
    F(cl_device_info, CL_DEVICE_BUILT_IN_KERNELS_WITH_VERSION_KHR,             \
      cl::vector<cl_name_version_khr>)
...
#define CL_HPP_PARAM_NAME_CL_KHR_SEMAPHORE_(F)                                 \
    ...
    F(cl_semaphore_info_khr, CL_SEMAPHORE_PROPERTIES_KHR,                      \
      cl::vector<cl_semaphore_properties_khr>)                                 \
    F(cl_semaphore_info_khr, CL_SEMAPHORE_TYPE_KHR, cl_semaphore_type_khr)     \
    F(cl_semaphore_info_khr, CL_SEMAPHORE_PAYLOAD_KHR,                         \
      cl_semaphore_payload_khr)                                                \
    F(cl_platform_info, CL_PLATFORM_SEMAPHORE_TYPES_KHR,                       \
      cl::vector<cl_semaphore_type_khr>)                                       \
    F(cl_device_info, CL_DEVICE_SEMAPHORE_TYPES_KHR,                           \
      cl::vector<cl_semaphore_type_khr>)

#define CL_HPP_PARAM_NAME_CL_KHR_EXTERNAL_MEMORY_(F)                           \
    F(cl_device_info, CL_DEVICE_EXTERNAL_MEMORY_IMPORT_HANDLE_TYPES_KHR,       \
      cl::vector<cl::ExternalMemoryType>)                                      \
    F(cl_platform_info, CL_PLATFORM_EXTERNAL_MEMORY_IMPORT_HANDLE_TYPES_KHR,   \
      cl::vector<cl::ExternalMemoryType>)

#define CL_HPP_PARAM_NAME_CL_KHR_EXTERNAL_SEMAPHORE_(F)                        \
    F(cl_platform_info, CL_PLATFORM_SEMAPHORE_IMPORT_HANDLE_TYPES_KHR,         \
      cl::vector<cl_external_semaphore_handle_type_khr>)                       \
    F(cl_platform_info, CL_PLATFORM_SEMAPHORE_EXPORT_HANDLE_TYPES_KHR,         \
      cl::vector<cl_external_semaphore_handle_type_khr>)                       \
    F(cl_device_info, CL_DEVICE_SEMAPHORE_IMPORT_HANDLE_TYPES_KHR,             \
      cl::vector<cl_external_semaphore_handle_type_khr>)                       \
    F(cl_device_info, CL_DEVICE_SEMAPHORE_EXPORT_HANDLE_TYPES_KHR,             \
      cl::vector<cl_external_semaphore_handle_type_khr>)                       \
    F(cl_semaphore_info_khr, CL_SEMAPHORE_EXPORT_HANDLE_TYPES_KHR,             \
      cl::vector<cl_external_semaphore_handle_type_khr>)

#define CL_HPP_PARAM_NAME_CL_KHR_EXTERNAL_SEMAPHORE_OPAQUE_FD_EXT(F)           \
    F(cl_external_semaphore_handle_type_khr,                                   \
      CL_SEMAPHORE_HANDLE_OPAQUE_FD_KHR, int)

#define CL_HPP_PARAM_NAME_CL_KHR_EXTERNAL_SEMAPHORE_SYNC_FD_EXT(F)             \
    F(cl_external_semaphore_handle_type_khr, CL_SEMAPHORE_HANDLE_SYNC_FD_KHR,  \
      int)

#define CL_HPP_PARAM_NAME_CL_KHR_EXTERNAL_SEMAPHORE_WIN32_EXT(F)               \
    F(cl_external_semaphore_handle_type_khr,                                   \
      CL_SEMAPHORE_HANDLE_OPAQUE_WIN32_KHR, void*)                             \
    F(cl_external_semaphore_handle_type_khr,                                   \
      CL_SEMAPHORE_HANDLE_OPAQUE_WIN32_KMT_KHR, void*)

#define CL_HPP_PARAM_NAME_INFO_3_0_(F)                                         \
    F(cl_platform_info, CL_PLATFORM_NUMERIC_VERSION, cl_version)               \
    F(cl_platform_info, CL_PLATFORM_EXTENSIONS_WITH_VERSION,                   \
      cl::vector<cl_name_version>)                                             \
                                                                               \
    F(cl_device_info, CL_DEVICE_NUMERIC_VERSION, cl_version)                   \
    F(cl_device_info, CL_DEVICE_EXTENSIONS_WITH_VERSION,                       \
      cl::vector<cl_name_version>)                                             \
    F(cl_device_info, CL_DEVICE_ILS_WITH_VERSION, cl::vector<cl_name_version>) \
    F(cl_device_info, CL_DEVICE_BUILT_IN_KERNELS_WITH_VERSION,                 \
      cl::vector<cl_name_version>)                                             \
    F(cl_device_info, CL_DEVICE_ATOMIC_MEMORY_CAPABILITIES,                    \
      cl_device_atomic_capabilities)                                           \
    F(cl_device_info, CL_DEVICE_ATOMIC_FENCE_CAPABILITIES,                     \
      cl_device_atomic_capabilities)                                           \
    F(cl_device_info, CL_DEVICE_NON_UNIFORM_WORK_GROUP_SUPPORT, cl_bool)       \
    F(cl_device_info, CL_DEVICE_OPENCL_C_ALL_VERSIONS,                         \
      cl::vector<cl_name_version>)                                             \
    F(cl_device_info, CL_DEVICE_PREFERRED_WORK_GROUP_SIZE_MULTIPLE, size_type) \
    F(cl_device_info, CL_DEVICE_WORK_GROUP_COLLECTIVE_FUNCTIONS_SUPPORT,       \
      cl_bool)                                                                 \
    F(cl_device_info, CL_DEVICE_GENERIC_ADDRESS_SPACE_SUPPORT, cl_bool)        \
    F(cl_device_info, CL_DEVICE_OPENCL_C_FEATURES,                             \
      cl::vector<cl_name_version>)                                             \
    ...
    F(cl_device_info, CL_DEVICE_LATEST_CONFORMANCE_VERSION_PASSED, string)     \
                                                                               \
    F(cl_command_queue_info, CL_QUEUE_PROPERTIES_ARRAY,                        \
      cl::vector<cl_queue_properties>)                                         \
...
#define CL_HPP_PARAM_NAME_CL_IMAGE_REQUIREMENTS_EXT(F)                         \
    F(cl_image_requirements_info_ext,                                          \
      CL_IMAGE_REQUIREMENTS_ROW_PITCH_ALIGNMENT_EXT, size_type)                \
    F(cl_image_requirements_info_ext,                                          \
      CL_IMAGE_REQUIREMENTS_BASE_ADDRESS_ALIGNMENT_EXT, size_type)             \
    F(cl_image_requirements_info_ext, CL_IMAGE_REQUIREMENTS_SIZE_EXT,          \
      size_type)                                                               \
    F(cl_image_requirements_info_ext, CL_IMAGE_REQUIREMENTS_MAX_WIDTH_EXT,     \
      cl_uint)                                                                 \
    F(cl_image_requirements_info_ext, CL_IMAGE_REQUIREMENTS_MAX_HEIGHT_EXT,    \
      cl_uint)                                                                 \
    F(cl_image_requirements_info_ext, CL_IMAGE_REQUIREMENTS_MAX_DEPTH_EXT,     \
      cl_uint)                                                                 \
    F(cl_image_requirements_info_ext,                                          \
      CL_IMAGE_REQUIREMENTS_MAX_ARRAY_SIZE_EXT, cl_uint)

#define CL_HPP_PARAM_NAME_CL_IMAGE_REQUIREMENTS_SLICE_PITCH_ALIGNMENT_EXT(F)   \
    F(cl_image_requirements_info_ext,                                          \
      CL_IMAGE_REQUIREMENTS_SLICE_PITCH_ALIGNMENT_EXT, size_type)

#define CL_HPP_PARAM_NAME_CL_INTEL_COMMAND_QUEUE_FAMILIES_(F)                  \
    F(cl_device_info, CL_DEVICE_QUEUE_FAMILY_PROPERTIES_INTEL,                 \
...
#define CL_HPP_PARAM_NAME_CL_INTEL_UNIFIED_SHARED_MEMORY_(F)                   \
    F(cl_device_info, CL_DEVICE_HOST_MEM_CAPABILITIES_INTEL,                   \
      cl_device_unified_shared_memory_capabilities_intel)                      \
    F(cl_device_info, CL_DEVICE_DEVICE_MEM_CAPABILITIES_INTEL,                 \
      cl_device_unified_shared_memory_capabilities_intel)                      \
    F(cl_device_info, CL_DEVICE_SINGLE_DEVICE_SHARED_MEM_CAPABILITIES_INTEL,   \
      cl_device_unified_shared_memory_capabilities_intel)                      \
    F(cl_device_info, CL_DEVICE_CROSS_DEVICE_SHARED_MEM_CAPABILITIES_INTEL,    \
      cl_device_unified_shared_memory_capabilities_intel)                      \
    F(cl_device_info, CL_DEVICE_SHARED_SYSTEM_MEM_CAPABILITIES_INTEL,          \
      cl_device_unified_shared_memory_capabilities_intel)
...
#if CL_HPP_TARGET_OPENCL_VERSION < 300
CL_HPP_PARAM_NAME_CL_KHR_EXTENDED_VERSIONING_CL3_SHARED_(
    CL_HPP_DECLARE_PARAM_TRAITS_)
#endif // CL_HPP_TARGET_OPENCL_VERSION < 300
CL_HPP_PARAM_NAME_CL_KHR_EXTENDED_VERSIONING_KHRONLY_(
    CL_HPP_DECLARE_PARAM_TRAITS_)
...
CL_HPP_DECLARE_PARAM_TRAITS_(cl_semaphore_info_khr,
...
CL_HPP_DECLARE_PARAM_TRAITS_(cl_device_info,
                             CL_DEVICE_IMAGE_PITCH_ALIGNMENT_KHR, cl_uint)
#endif
...
CL_HPP_PARAM_NAME_CL_IMAGE_REQUIREMENTS_SLICE_PITCH_ALIGNMENT_EXT(
    CL_HPP_DECLARE_PARAM_TRAITS_)
...
CL_HPP_DECLARE_PARAM_TRAITS_(
    cl_kernel_exec_info, CL_KERNEL_EXEC_INFO_WORKGROUP_BATCH_SIZE_MODIFIER_ARM,
    cl_int)
#endif
...
#endif
CL_HPP_DECLARE_PARAM_TRAITS_(
    cl_device_info, CL_DEVICE_COMMAND_BUFFER_REQUIRED_QUEUE_PROPERTIES_KHR,
    cl_command_queue_properties)
CL_HPP_DECLARE_PARAM_TRAITS_(cl_command_buffer_info_khr,
                             CL_COMMAND_BUFFER_QUEUES_KHR,
                             cl::vector<CommandQueue>)
CL_HPP_DECLARE_PARAM_TRAITS_(cl_command_buffer_info_khr,
                             CL_COMMAND_BUFFER_NUM_QUEUES_KHR, cl_uint)
CL_HPP_DECLARE_PARAM_TRAITS_(cl_command_buffer_info_khr,
                             CL_COMMAND_BUFFER_REFERENCE_COUNT_KHR, cl_uint)
CL_HPP_DECLARE_PARAM_TRAITS_(cl_command_buffer_info_khr,
...
#if defined(cl_khr_command_buffer_mutable_dispatch)
CL_HPP_DECLARE_PARAM_TRAITS_(cl_mutable_command_info_khr,
                             CL_MUTABLE_COMMAND_COMMAND_QUEUE_KHR, CommandQueue)
CL_HPP_DECLARE_PARAM_TRAITS_(cl_mutable_command_info_khr,
...
#else
CL_HPP_DECLARE_PARAM_TRAITS_(
    cl_mutable_command_info_khr, CL_MUTABLE_DISPATCH_PROPERTIES_ARRAY_KHR,
    cl::vector<cl_ndrange_kernel_command_properties_khr>)
#endif
CL_HPP_DECLARE_PARAM_TRAITS_(cl_mutable_command_info_khr,
                             CL_MUTABLE_DISPATCH_KERNEL_KHR, cl_kernel)
CL_HPP_DECLARE_PARAM_TRAITS_(cl_mutable_command_info_khr,
                             CL_MUTABLE_DISPATCH_DIMENSIONS_KHR, cl_uint)
CL_HPP_DECLARE_PARAM_TRAITS_(cl_mutable_command_info_khr,
...
CL_HPP_DECLARE_PARAM_TRAITS_(cl_device_info, CL_DEVICE_IP_VERSION_INTEL,
                             cl_uint)
CL_HPP_DECLARE_PARAM_TRAITS_(cl_device_info, CL_DEVICE_ID_INTEL, cl_uint)
CL_HPP_DECLARE_PARAM_TRAITS_(cl_device_info, CL_DEVICE_NUM_SLICES_INTEL,
                             cl_uint)
CL_HPP_DECLARE_PARAM_TRAITS_(cl_device_info,
                             CL_DEVICE_NUM_SUB_SLICES_PER_SLICE_INTEL, cl_uint)
CL_HPP_DECLARE_PARAM_TRAITS_(cl_device_info,
                             CL_DEVICE_NUM_EUS_PER_SUB_SLICE_INTEL, cl_uint)
CL_HPP_DECLARE_PARAM_TRAITS_(cl_device_info, CL_DEVICE_NUM_THREADS_PER_EU_INTEL,
                             cl_uint)
CL_HPP_DECLARE_PARAM_TRAITS_(cl_device_info,
...
CL_HPP_DECLARE_PARAM_TRAITS_(cl_device_info, CL_DEVICE_SUB_GROUP_SIZES_INTEL,
                             cl::vector<size_type>)
CL_HPP_DECLARE_PARAM_TRAITS_(cl_kernel_work_group_info,
                             CL_KERNEL_SPILL_MEM_SIZE_INTEL, cl_ulong)
...
template <> struct ReferenceHandler<cl_event> {
    static cl_int retain(cl_event event) { return CL_(clRetainEvent)(event); }
    static cl_int release(cl_event event) { return CL_(clReleaseEvent)(event); }
};
...
template <> struct ReferenceHandler<cl_command_buffer_khr> {
    static cl_int retain(cl_command_buffer_khr cmdBufferKhr) {
        if (pfn_clRetainCommandBufferKHR == nullptr) {
            return detail::errHandler(CL_INVALID_OPERATION,
                                      __RETAIN_COMMAND_BUFFER_KHR_ERR);
        }
    ...
    static cl_int release(cl_command_buffer_khr cmdBufferKhr) {
        if (pfn_clReleaseCommandBufferKHR == nullptr) {
            return detail::errHandler(CL_INVALID_OPERATION,
                                      __RELEASE_COMMAND_BUFFER_KHR_ERR);
        }
...
template <> struct ReferenceHandler<cl_mutable_command_khr> {
    ...
    static cl_int retain(cl_mutable_command_khr) { return CL_SUCCESS; }
    // cl_mutable_command_khr does not have release().
    static cl_int release(cl_mutable_command_khr) { return CL_SUCCESS; }
};
#endif // cl_khr_command_buffer
...
static cl_uint getPlatformVersion(cl_platform_id platform) {
    ...
    CL_(clGetPlatformInfo)(platform, CL_PLATFORM_VERSION, size,
                           versionInfo.data(), &size);
    return getVersion(versionInfo);
}

static cl_uint getDevicePlatformVersion(cl_device_id device) {
    cl_platform_id platform;
    CL_(clGetDeviceInfo)(device, CL_DEVICE_PLATFORM, sizeof(platform),
                         &platform, nullptr);
...
static cl_uint getContextPlatformVersion(cl_context context) {
    ...
    CL_(clGetContextInfo)(context, CL_CONTEXT_DEVICES, size, devices.data(),
                          nullptr);
...
class Device : public detail::Wrapper<cl_device_id> {
  ...
  public:
    ...
    /**
     * Return a synchronized pair of host and device timestamps as seen by
     * device. Use to correlate the clocks and get the host timer only using
     * getHostTimer as a lower cost mechanism in between calls. The resolution
     * of the host timer may be queried with the
    ...
    getDeviceAndHostTimer(cl_int* error = nullptr) {
        std::pair<cl_ulong, cl_ulong> retVal;
        cl_int err = CL_(clGetDeviceAndHostTimer)(this->get(), &(retVal.first),
                                                  &(retVal.second));
...
class Platform : public detail::Wrapper<cl_platform_id> {
  ...
  public:
     ...
     * OpenCL device. If \a devices argument is nullptr, this argument is
     * ignored.
     *
    ...
    cl_int getDevices(cl_d3d10_device_source_khr d3d_device_source,
        ...
        static PFN_clGetDeviceIDsFromD3D10KHR pfn_clGetDeviceIDsFromD3D10KHR =
            nullptr;
#if CL_HPP_TARGET_OPENCL_VERSION >= 120
        CL_HPP_INIT_CL_EXT_FCN_PTR_PLATFORM_(object_,
    ...
    cl_int unloadCompiler() { return CL_(clUnloadPlatformCompiler)(object_); }
#endif // CL_HPP_TARGET_OPENCL_VERSION >= 120
}; // class Platform
...
//! \brief Wrapper for clCreateSubDevices().
inline cl_int
Device::createSubDevices(const cl_device_partition_property_ext* properties,
                         vector<Device>* devices) {
#if CL_HPP_TARGET_OPENCL_VERSION >= 120
...
inline cl_int UnloadCompiler() { return CL_(clUnloadCompiler)(); }
#endif // #if defined(CL_USE_DEPRECATED_OPENCL_1_1_APIS)
  ...
  private:
    ...
    static void makeDefault() {
...
#endif
        {
            ...
            default_ = Context(CL_DEVICE_TYPE_DEFAULT, properties, nullptr,
                               nullptr, &default_error_);
        }
#if defined(CL_HPP_ENABLE_EXCEPTIONS)
        catch (cl::Error& e) {
            default_error_ = e.err();
    ...
    struct ImageRequirementsInfo {
        ...
        ImageRequirementsInfo(cl_mem_flags f,
    ...
    static cl_int getImageRequirementsInfoExtHelper(
        const Context& context, const ImageRequirementsInfo& info,
        cl_image_requirements_info_ext param_name, size_type param_value_size,
        void* param_value, size_type* param_value_size_ret) {
        ...
        return detail::errHandler(pfn_clGetImageRequirementsInfoEXT(
                                      context(), info.properties, info.flags,
                                      info.image_format, info.image_desc,
  ...
  public:
    ...
    Context(const vector<Device>& devices,
            ...
            void(CL_CALLBACK* notifyFptr)(const char*, const void*, size_type,
                                          void*)    = nullptr,
            void* data = nullptr, cl_int* err = nullptr) {
        cl_int error;

        size_type numDevices = devices.size();
        vector<cl_device_id> deviceIDs(numDevices);

        for (size_type deviceIndex = 0; deviceIndex < numDevices;
             ++deviceIndex) {
            deviceIDs[deviceIndex] = (devices[deviceIndex])();
        }

        object_ =
            CL_(clCreateContext)(properties, (cl_uint)numDevices,
    ...
    Context(const Device& device,
        ...
        object_ = CL_(clCreateContext)(properties, 1, &deviceID, notifyFptr,
                                       data, &error);
...
#endif
        object_ = CL_(clCreateContextFromType)(properties, type, notifyFptr,
                                               data, &error);
    ...
    cl_int getSupportedImageFormats(cl_mem_flags flags, cl_mem_object_type type,
        ...
        cl_int err = CL_(clGetSupportedImageFormats)(object_, flags, type, 0,
                                                     nullptr, &numEntries);
        if (err != CL_SUCCESS) {
        ...
        if (numEntries > 0) {
            ...
            err = CL_(clGetSupportedImageFormats)(
                ...
                (cl_image_format*)value.data(), nullptr);
            if (err != CL_SUCCESS) {
                return detail::errHandler(err,
                                          __GET_SUPPORTED_IMAGE_FORMATS_ERR);
            }

            formats->assign(value.begin(), value.end());
        } else {
            // If no values are being returned, ensure an empty vector comes
            // back
            formats->clear();
        }
    ...
    cl_int getImageRequirementsInfoExt(
        cl_image_requirements_info_ext name, T* param, cl_mem_flags flags = 0,
        ...
        ImageRequirementsInfo imageInfo = {flags, properties, image_format,
                                           image_desc};

        return detail::errHandler(
            detail::getInfo(Context::getImageRequirementsInfoExtHelper, *this,
                            imageInfo, name, param),
            __GET_IMAGE_REQUIREMENT_INFO_EXT_ERR);
    }

    template <cl_image_requirements_info_ext type>
    typename detail::param_traits<detail::cl_image_requirements_info_ext,
                                  type>::param_type
    getImageRequirementsInfoExt(cl_mem_flags flags                  = 0,
        ...
        cl_int result = getImageRequirementsInfoExt(
            type, &param, flags, properties, image_format, image_desc);
        if (err != nullptr) {
            *err = result;
        }
        return param;
     ...
     * callback functions are called in the reverse order in which they were
     * registered. If a context callback function was specified when context was
     * created, it will not be called after any context destructor callback is
     * called.
     */
    cl_int setDestructorCallback(void(CL_CALLBACK* pfn_notify)(cl_context,
                                                               void*),
...
class Event : public detail::Wrapper<cl_event> {
  public:
     ...
     */
    cl_int wait() const {
        return detail::errHandler(CL_(clWaitForEvents)(1, &object_),
    ...
    static cl_int waitForEvents(const vector<Event>& events) {
        ...
        return detail::errHandler(
            CL_(clWaitForEvents)((cl_uint)events.size(),
                                 (events.size() > 0)
...
class UserEvent : public Event {
  public:
    ...
    cl_int setStatus(cl_int status) {
        return detail::errHandler(CL_(clSetUserEventStatus)(object_, status),
...
class Memory : public detail::Wrapper<cl_mem> {
  public:
    ...
    cl_int setDestructorCallback(void(CL_CALLBACK* pfn_notify)(cl_mem, void*),
                                 void* user_data = nullptr) {
        return detail::errHandler(CL_(clSetMemObjectDestructorCallback)(
                                      object_, pfn_notify, user_data),
...
template <typename T>
inline cl_int
enqueueMapSVM(T* ptr, cl_bool blocking, cl_map_flags flags, size_type size,
              const vector<Event>* events = nullptr, Event* event = nullptr);
...
template <typename T, class SVMTrait> class SVMAllocator {
  ...
  public:
    ...
    pointer address(reference r) noexcept { return std::addressof(r); }
    ...
    allocate(size_type size,
        ...
        void* voidPointer = CL_(clSVMAlloc)(
            context_(), SVMTrait::getSVMMemFlags(), size * sizeof(T), 0);
        ...
        if (map &&
            !(SVMTrait::getSVMMemFlags() & CL_MEM_SVM_FINE_GRAIN_BUFFER)) {
            cl_int err =
                enqueueMapSVM(retValue, CL_TRUE, CL_MAP_READ | CL_MAP_WRITE,
                              size * sizeof(T));
            if (err != CL_SUCCESS) {
    ...
    void deallocate(pointer p, size_type) { CL_(clSVMFree)(context_(), p); }
...
class Buffer : public Memory {
  public:
...
#if CL_HPP_TARGET_OPENCL_VERSION >= 300
    /*! \brief Constructs a Buffer in a specified context and with specified
     * properties.
     *
     ...
     *                  specified. Note alignment & exclusivity requirements.
     */
    Buffer(const Context& context, const vector<cl_mem_properties>& properties,
           cl_mem_flags flags, size_type size, void* host_ptr = nullptr,
           cl_int* err = nullptr) {
        cl_int error;
     ...
     *  \see Context::getDefault()
     */
    Buffer(cl_mem_flags flags, size_type size, void* host_ptr = nullptr,
           cl_int* err = nullptr)
        : Buffer(Context::getDefault(err), flags, size, host_ptr, err) {}

#if CL_HPP_TARGET_OPENCL_VERSION >= 300
    /*! \brief Constructs a Buffer in the default context and with specified
     * properties.
     *
     *  Wraps clCreateBufferWithProperties().
     *
     ...
     *  \see Context::getDefault()
     */
    Buffer(const vector<cl_mem_properties>& properties, cl_mem_flags flags,
           size_type size, void* host_ptr = nullptr, cl_int* err = nullptr)
        : Buffer(Context::getDefault(err), properties, flags, size, host_ptr,
                 err) {}
#endif
    ...
    Buffer(IteratorType startIterator, IteratorType endIterator, bool readOnly,
           bool useHostPtr = false, cl_int* err = nullptr) {
        typedef
        ...
        if (useHostPtr) {
            object_ = CL_(clCreateBuffer)(
                context(), flags, size, const_cast<DataType*>(&*startIterator),
                &error);
        } else {
...
class BufferD3D10 : public Buffer {
  public:
    ...
    BufferD3D10(const Context& context, cl_mem_flags flags,
                ID3D10Buffer* bufobj, cl_int* err = nullptr)
        : pfn_clCreateFromD3D10BufferKHR(nullptr) {
        typedef CL_API_ENTRY cl_mem(CL_API_CALL *
                                    PFN_clCreateFromD3D10BufferKHR)(
...
class BufferRenderGL : public Buffer {
  public:
    ...
    BufferRenderGL(const Context& context, cl_mem_flags flags, cl_GLuint bufobj,
        ...
        cl_int error;
        object_ =
            CL_(clCreateFromGLRenderbuffer)(context(), flags, bufobj, &error);
...
class Image1D : public Image {
  public:
    ...
    Image1D(const Context& context, cl_mem_flags flags, ImageFormat format,
            size_type width, void* host_ptr = nullptr, cl_int* err = nullptr) {
        cl_int error;
        ...
        object_ = CL_(clCreateImage)(context(), flags, &format, &desc, host_ptr,
                                     &error);
    ...
    Image1D(const Context& context, const vector<cl_mem_properties>& properties,
        ...
        if (properties.empty()) {
            ...
            object_ = CL_(clCreateImageWithProperties)(
                context(), properties.data(), flags, &format, &desc, host_ptr,
                &error);
        }
...
class Image1DBuffer : public Image {
  public:
    Image1DBuffer(const Context& context, cl_mem_flags flags,
                  ImageFormat format, size_type width, const Buffer& buffer,
                  cl_int* err = nullptr) {
        cl_int error;
        ...
        object_ = CL_(clCreateImage)(context(), flags, &format, &desc, nullptr,
                                     &error);
    ...
    Image1DBuffer(const Context& context,
        ...
        if (properties.empty()) {
            ...
            object_ = CL_(clCreateImageWithProperties)(
                context(), properties.data(), flags, &format, &desc, nullptr,
                &error);
        }
  ...
  public:
    ...
    Image2D(const Context& context, cl_mem_flags flags, ImageFormat format,
        ...
        if (useCreateImage) {
            ...
            object_ = CL_(clCreateImage)(context(), flags, &format, &desc,
                                         host_ptr, &error);
...
#if CL_HPP_MINIMUM_OPENCL_VERSION < 120
        if (!useCreateImage) {
            object_ = CL_(clCreateImage2D)(context(), flags, &format, width,
    ...
    Image2D(const Context& context, ImageFormat format,
        ...
        object_ = CL_(clCreateImage)(context(),
...
class CL_API_PREFIX__VERSION_1_1_DEPRECATED Image2DGL : public Image2D {
  public:
    ...
    Image2DGL(const Context& context, cl_mem_flags flags, cl_GLenum target,
              cl_GLint miplevel, cl_GLuint texobj, cl_int* err = nullptr) {
        cl_int error;
        object_ = CL_(clCreateFromGLTexture2D)(context(), flags, target,
                                               miplevel, texobj, &error);
...
class Image2DArray : public Image {
  public:
    Image2DArray(const Context& context, cl_mem_flags flags, ImageFormat format,
                 ...
                 size_type rowPitch, size_type slicePitch,
                 void* host_ptr = nullptr, cl_int* err = nullptr) {
        cl_int error;
...
#if CL_HPP_MINIMUM_OPENCL_VERSION < 120
        if (!useCreateImage) {
            object_ = CL_(clCreateImage3D)(context(), flags, &format, width,
...
class Image3DGL : public Image3D {
  public:
    ...
    Image3DGL(const Context& context, cl_mem_flags flags, cl_GLenum target,
              cl_GLint miplevel, cl_GLuint texobj, cl_int* err = nullptr) {
        cl_int error;
        object_ = CL_(clCreateFromGLTexture3D)(context(), flags, target,
                                               miplevel, texobj, &error);
...
class ImageGL : public Image {
  public:
    ImageGL(const Context& context, cl_mem_flags flags, cl_GLenum target,
            cl_GLint miplevel, cl_GLuint texobj, cl_int* err = nullptr) {
        cl_int error;
        object_ = CL_(clCreateFromGLTexture)(context(), flags, target, miplevel,
                                             texobj, &error);
...
class Pipe : public Memory {
  public:
     ...
     * @param flags Bitfield. Only CL_MEM_READ_WRITE and CL_MEM_HOST_NO_ACCESS
     * are valid.
    ...
    Pipe(const Context& context, cl_uint packet_size, cl_uint max_packets,
        ...
        object_ = CL_(clCreatePipe)(context(), flags, packet_size, max_packets,
                                    nullptr, &error);
  ...
  public:
    ...
    Sampler(const Context& context, cl_bool normalized_coords,
        ...
        object_ = CL_(clCreateSamplerWithProperties)(
            context(), sampler_properties, &error);
...
#else
        object_ = CL_(clCreateSampler)(context(), normalized_coords,
...
class Kernel : public detail::Wrapper<cl_kernel> {
  public:
    inline Kernel(const Program& program, const string& name,
                  cl_int* err = nullptr);
    ...
    cl_int getArgInfo(cl_uint argIndex, cl_kernel_arg_info name,
                      T* param) const {
        return detail::errHandler(detail::getInfo(CL_(clGetKernelArgInfo),
                                                  object_, argIndex, name,
                                                  param),
    ...
    cl_int getWorkGroupInfo(const Device& device,
        ...
        return detail::errHandler(detail::getInfo(CL_(clGetKernelWorkGroupInfo),
                                                  object_, device(), name,
                                                  param),
    ...
    cl_int getSubGroupInfo(const cl::Device& dev, cl_kernel_sub_group_info name,
        ...
        return detail::errHandler(
            CL_(clGetKernelSubGroupInfo)(object_, dev(), name, range.size(),
...
#endif // defined(CL_HPP_USE_CL_SUB_GROUPS_KHR) || CL_HPP_TARGET_OPENCL_VERSION
       // >= 210
    ...
    setArg(cl_uint index, const T& value) {
        return detail::errHandler(
            CL_(clSetKernelArg)(object_, index,
     ...
     *
     * \note It is only possible to enable fine-grained system SVM if all
     * devices in the context associated with kernel support it.
     *
    ...
    template <int index, int ArrayLength, class D, typename T0, typename T1,
              typename... Ts>
    ...
    template <int index, int ArrayLength, typename T0, typename T1,
              typename... Ts>
    ...
    cl_int setExecInfo(cl_kernel_exec_info param_name, const T& val) {
        return detail::errHandler(
            CL_(clSetKernelExecInfo)(object_, param_name, sizeof(T), &val));
    }

    template <cl_kernel_exec_info name>
    cl_int
    setExecInfo(typename detail::param_traits<detail::cl_kernel_exec_info,
                                              name>::param_type& val) {
     ...
     * @return A new kernel object with internal state entirely separate from
     * that of the original but with any arguments set on the original intact.
     */
    Kernel clone() {
        cl_int error;
...
class Program : public detail::Wrapper<cl_program> {
  public:
    ...
    Program(const string& source, bool build = false, cl_int* err = nullptr) {
        ...
        object_ = CL_(clCreateProgramWithSource)(context(), (cl_uint)1,
                                                 &strings, &length, &error);

        detail::errHandler(error, __CREATE_PROGRAM_WITH_SOURCE_ERR);

        if (error == CL_SUCCESS && build) {

            error = CL_(clBuildProgram)(object_, 0, nullptr,
    ...
    /**
     * Program constructor to allow construction of program from SPIR-V or
     * another IL.
     *
    ...
    /**
     * Program constructor to allow construction of program from SPIR-V or
     * another IL for a specific context.
     *
     * Requires OpenCL 2.1 or newer or the cl_khr_il_program extension.
     */
    Program(const Context& context, const vector<char>& IL, bool build = false,
            cl_int* err = nullptr) {
        cl_int error;
     ...
     * \param devices A vector of OpenCL device objects for which the program
     * will be created.
     ...
     * to match the size of binaries and filled with values to specify if each
     * binary was successfully loaded. Set to CL_SUCCESS if the binary was
     * successfully loaded. Set to CL_INVALID_VALUE if the length is 0 or the
     * binary pointer is nullptr. Set to CL_INVALID_BINARY if the binary
     * provided is not valid for the matching device.
     * \param err if non-nullptr will be set to CL_SUCCESS on successful
     * operation or one of the following errors: CL_INVALID_CONTEXT if context
     * is not a valid context. CL_INVALID_VALUE if the length of devices is
     * zero; or if the length of binaries does not match the length of devices;
    ...
    Program(const Context& context, const vector<Device>& devices,
            const Binaries& binaries, vector<cl_int>* binaryStatus = nullptr,
            cl_int* err = nullptr) {
        cl_int error;
       ...
       // !defined(CL_HPP_ENABLE_PROGRAM_CONSTRUCTION_FROM_ARRAY_COMPATIBILITY)
        ...
        object_ = CL_(clCreateProgramWithBinary)(
            ...
            (binaryStatus != nullptr && numDevices > 0) ? &binaryStatus->front()
                                                        : nullptr,
            &error);
     ...
     */
    Program(const Context& context, const vector<Device>& devices,
            const string& kernelNames, cl_int* err = nullptr) {
        cl_int error;
    ...
    cl_int build(const vector<Device>& devices, const string& options,
                 void(CL_CALLBACK* notifyFptr)(cl_program, void*) = nullptr,
                 void* data = nullptr) const {
        return build(devices, options.c_str(), notifyFptr, data);
    }

    cl_int build(const vector<Device>& devices, const char* options = nullptr,
                 void(CL_CALLBACK* notifyFptr)(cl_program, void*) = nullptr,
                 void* data = nullptr) const {
        size_type numDevices = devices.size();
        vector<cl_device_id> deviceIDs(numDevices);
        ...
        cl_int buildError =
            CL_(clBuildProgram)(object_, (cl_uint)devices.size(),
                                deviceIDs.data(), options, notifyFptr, data);

        return detail::buildErrHandler(buildError, __BUILD_PROGRAM_ERR,
                                       getBuildInfo<CL_PROGRAM_BUILD_LOG>());
    }

    cl_int build(const Device& device, const string& options,
                 void(CL_CALLBACK* notifyFptr)(cl_program, void*) = nullptr,
                 void* data = nullptr) const {
        return build(device, options.c_str(), notifyFptr, data);
    }

    cl_int build(const Device& device, const char* options = nullptr,
                 void(CL_CALLBACK* notifyFptr)(cl_program, void*) = nullptr,
                 void* data = nullptr) const {
        cl_device_id deviceID = device();

        cl_int buildError = CL_(clBuildProgram)(object_, 1, &deviceID, options,
                                                notifyFptr, data);

        BuildLogType buildLog(0);
        buildLog.push_back(
            std::make_pair(device, getBuildInfo<CL_PROGRAM_BUILD_LOG>(device)));
        return detail::buildErrHandler(buildError, __BUILD_PROGRAM_ERR,
                                       buildLog);
    }

    cl_int build(const string& options,
                 void(CL_CALLBACK* notifyFptr)(cl_program, void*) = nullptr,
                 void* data = nullptr) const {
        return build(options.c_str(), notifyFptr, data);
    }

    cl_int build(const char* options                              = nullptr,
                 void(CL_CALLBACK* notifyFptr)(cl_program, void*) = nullptr,
                 void* data = nullptr) const {
        cl_int buildError =
            CL_(clBuildProgram)(object_, 0, nullptr, options, notifyFptr, data);
...
#if CL_HPP_TARGET_OPENCL_VERSION >= 120
    cl_int compile(const string& options,
                   void(CL_CALLBACK* notifyFptr)(cl_program, void*) = nullptr,
                   void* data = nullptr) const {
        return compile(options.c_str(), notifyFptr, data);
    }

    cl_int compile(const char* options                              = nullptr,
                   void(CL_CALLBACK* notifyFptr)(cl_program, void*) = nullptr,
                   void* data = nullptr) const {
        cl_int error =
            CL_(clCompileProgram)(object_, 0, nullptr, options, 0, nullptr,
                                  nullptr, notifyFptr, data);
        return detail::buildErrHandler(error, __COMPILE_PROGRAM_ERR,
                                       getBuildInfo<CL_PROGRAM_BUILD_LOG>());
    }

    cl_int compile(const string& options, const vector<Program>& inputHeaders,
                   const vector<string>& headerIncludeNames,
                   void(CL_CALLBACK* notifyFptr)(cl_program, void*) = nullptr,
                   void* data = nullptr) const {
        return compile(options.c_str(), inputHeaders, headerIncludeNames,
                       notifyFptr, data);
    }

    cl_int compile(const char* options, const vector<Program>& inputHeaders,
                   const vector<string>& headerIncludeNames,
                   void(CL_CALLBACK* notifyFptr)(cl_program, void*) = nullptr,
                   void* data = nullptr) const {
        static_assert(
    ...
    cl_int compile(const string& options, const vector<Device>& deviceList,
                   const vector<Program>& inputHeaders      = vector<Program>(),
                   const vector<string>& headerIncludeNames = vector<string>(),
                   void(CL_CALLBACK* notifyFptr)(cl_program, void*) = nullptr,
                   void* data = nullptr) const {
        return compile(options.c_str(), deviceList, inputHeaders,
                       headerIncludeNames, notifyFptr, data);
    }

    cl_int compile(const char* options, const vector<Device>& deviceList,
                   const vector<Program>& inputHeaders      = vector<Program>(),
                   const vector<string>& headerIncludeNames = vector<string>(),
                   void(CL_CALLBACK* notifyFptr)(cl_program, void*) = nullptr,
                   void* data = nullptr) const {
        ...
        cl_int error = CL_(clCompileProgram)(
            object_, static_cast<cl_uint>(deviceList.size()),
            reinterpret_cast<const cl_device_id*>(deviceIDList.data()), options,
            static_cast<cl_uint>(inputHeaders.size()),
            reinterpret_cast<const cl_program*>(inputHeaders.data()),
            reinterpret_cast<const char**>(headerIncludeNamesCStr.data()),
            notifyFptr, data);
    ...
    cl_int getBuildInfo(const Device& device, cl_program_build_info name,
                        T* param) const {
        return detail::errHandler(detail::getInfo(CL_(clGetProgramBuildInfo),
                                                  object_, device(), name,
                                                  param),
     ...
     * specified info type and for all devices in the program. On an error
     * reading the info for any device, an empty vector of info will be
     * returned.
     */
    template <cl_program_build_info name>
    vector<std::pair<
    ...
    getBuildInfo(cl_int* err = nullptr) const {
        ...
        vector<std::pair<cl::Device,
                         typename detail::param_traits<
                             detail::cl_program_build_info, name>::param_type>>
            devInfo;
    ...
    cl_int createKernels(vector<Kernel>* kernels) {
        cl_uint numKernels;
        cl_int err =
            CL_(clCreateKernelsInProgram)(object_, 0, nullptr, &numKernels);
        if (err != CL_SUCCESS) {
        ...
        err = CL_(clCreateKernelsInProgram)(object_, numKernels, value.data(),
                                            nullptr);
        if (err != CL_SUCCESS) {
            return detail::errHandler(err, __CREATE_KERNELS_IN_PROGRAM_ERR);
        }
     ...
     *
     *  Each call to this function registers the specified user callback
     * function on a callback stack associated with program. The registered user
     * callback functions are called in the reverse order in which they were
     * registered.
     */
    ...
    setSpecializationConstant(cl_uint index, const T& value) {
        return detail::errHandler(CL_(clSetProgramSpecializationConstant)(
                                      object_, index, sizeof(value), &value),
     ...
     *  Wraps clSetProgramSpecializationConstant().
     */
    cl_int setSpecializationConstant(cl_uint index, size_type size,
                                     const void* value) {
        return detail::errHandler(CL_(clSetProgramSpecializationConstant)(
                                      object_, index, size, value),
                                  __SET_PROGRAM_SPECIALIZATION_CONSTANT_ERR);
    }
#endif // CL_HPP_TARGET_OPENCL_VERSION >= 220
};
...
#if CL_HPP_TARGET_OPENCL_VERSION >= 120
inline Program linkProgram(const Program& input1, const Program& input2,
    ...
    cl_program prog =
        CL_(clLinkProgram)(ctx(), 0, nullptr, options, 2, programs, notifyFptr,
                           data, &error_local);
...
inline Program
linkProgram(const Program& input1, const Program& input2, const string& options,
            void(CL_CALLBACK* notifyFptr)(cl_program, void*) = nullptr,
            void* data = nullptr, cl_int* err = nullptr) {
...
inline Program
linkProgram(const vector<Program>& inputPrograms, const char* options = nullptr,
            void(CL_CALLBACK* notifyFptr)(cl_program, void*) = nullptr,
            void* data = nullptr, cl_int* err = nullptr) {
    cl_int error_local = CL_SUCCESS;
    Context ctx;
    ...
    cl_program prog = CL_(clLinkProgram)(
        ctx(), 0, nullptr, options, static_cast<cl_uint>(inputPrograms.size()),
        reinterpret_cast<const cl_program*>(inputPrograms.data()), notifyFptr,
        data, &error_local);
...
inline Program
linkProgram(const vector<Program>& inputPrograms, const string& options,
            void(CL_CALLBACK* notifyFptr)(cl_program, void*) = nullptr,
            void* data = nullptr, cl_int* err = nullptr) {
...
template <>
inline cl_int cl::Program::setSpecializationConstant(cl_uint index,
                                                     const bool& value) {
    cl_uchar ucValue = value ? CL_UCHAR_MAX : 0;
    return detail::errHandler(CL_(clSetProgramSpecializationConstant)(
                                  object_, index, sizeof(ucValue), &ucValue),
                              __SET_PROGRAM_SPECIALIZATION_CONSTANT_ERR);
}
#endif // CL_HPP_TARGET_OPENCL_VERSION >= 220
...
class CommandQueue : public detail::Wrapper<cl_command_queue> {
  private:
    ...
    static void initMemoryExtension(const cl::Device& device) {
        ...
        CL_HPP_INIT_CL_EXT_FCN_PTR_PLATFORM_(
            platform, clEnqueueAcquireExternalMemObjectsKHR);
        CL_HPP_INIT_CL_EXT_FCN_PTR_PLATFORM_(
            platform, clEnqueueReleaseExternalMemObjectsKHR);

        if ((pfn_clEnqueueAcquireExternalMemObjectsKHR == nullptr) &&
            (pfn_clEnqueueReleaseExternalMemObjectsKHR == nullptr)) {
            detail::errHandler(CL_INVALID_VALUE,
                               __ENQUEUE_ACQUIRE_EXTERNAL_MEMORY_ERR);
        }
    }
#endif // cl_khr_external_memory
  ...
  public:
...
#if CL_HPP_MINIMUM_OPENCL_VERSION < 200
            if (!useWithProperties) {
                object_ = CL_(clCreateCommandQueue)(context(), device(),
                                                    properties, &error);
...
#if CL_HPP_MINIMUM_OPENCL_VERSION < 200
        if (!useWithProperties) {
            object_ = CL_(clCreateCommandQueue)(context(), devices[0](),
                                                properties, &error);
...
#if CL_HPP_MINIMUM_OPENCL_VERSION < 200
        if (!useWithProperties) {
            object_ = CL_(clCreateCommandQueue)(context(), device(), properties,
                                                &error);
    ...
    cl_int enqueueReadBufferRect(const Buffer& buffer, cl_bool blocking,
        ...
        return enqueueReadBufferRect(
            buffer, blocking, {buffer_offset[0], buffer_offset[1], 0},
            {host_offset[0], host_offset[1], 0}, {region[0], region[1], 1},
    ...
    cl_int enqueueCopyBufferRect(const Buffer& src, const Buffer& dst,
        ...
        return enqueueCopyBufferRect(
            src, dst, {src_origin[0], src_origin[1], 0},
            {dst_origin[0], dst_origin[1], 0}, {region[0], region[1], 1},
    ...
    cl_int enqueueReadImage(const Image& image, cl_bool blocking,
                            ...
                            void* ptr, const vector<Event>* events = nullptr,
                            Event* event = nullptr) const {
        cl_event tmp;
        cl_int err = detail::errHandler(
            CL_(clEnqueueReadImage)(
                object_, image(), blocking, origin.data(), region.data(),
    ...
    cl_int enqueueReadImage(const Image& image, cl_bool blocking,
                            ...
                            void* ptr, const vector<Event>* events = nullptr,
                            Event* event = nullptr) const {
        return enqueueReadImage(image, blocking, {origin[0], origin[1], 0},
    ...
    cl_int enqueueWriteImage(const Image& image, cl_bool blocking,
                             ...
                             const vector<Event>* events = nullptr,
                             Event* event                = nullptr) const {
        return enqueueWriteImage(image, blocking, {origin[0], origin[1], 0},
                                 {region[0], region[1], 1}, row_pitch,
                                 slice_pitch, ptr, events, event);
    }
    ...
    cl_int enqueueCopyImage(const Image& src, const Image& dst,
                            ...
                            const vector<Event>* events = nullptr,
                            Event* event                = nullptr) const {
        return enqueueCopyImage(src, dst, {src_origin[0], src_origin[1], 0},
                                {dst_origin[0], dst_origin[1], 0},
                                {region[0], region[1], 1}, events, event);
    }
    ...
    typename std::enable_if<std::is_same<T, cl_float4>::value ||
                            ...
                            cl_int>::type
    enqueueFillImage(const Image& image, T fillColor,
                     const array<size_type, 3>& origin,
                     const array<size_type, 3>& region,
                     const vector<Event>* events = nullptr,
                     Event* event                = nullptr) const {
    ...
    enqueueFillImage(const Image& image, T fillColor,
                     ...
                     const vector<Event>* events = nullptr,
                     Event* event                = nullptr) const {
        return enqueueFillImage(image, fillColor, {origin[0], origin[1], 0},
                                {region[0], region[1], 1}, events, event);
    }
#endif // CL_HPP_TARGET_OPENCL_VERSION >= 120
    ...
    cl_int enqueueCopyImageToBuffer(const Image& src, const Buffer& dst,
        ...
        cl_int err = detail::errHandler(
            CL_(clEnqueueCopyImageToBuffer)(
                object_, src(), dst(), src_origin.data(), region.data(),
                dst_offset, (events != nullptr) ? (cl_uint)events->size() : 0,
                (events != nullptr && events->size() > 0)
                    ? (const cl_event*)&events->front()
                    : nullptr,
                (event != nullptr) ? &tmp : nullptr),
    ...
    cl_int enqueueCopyImageToBuffer(const Image& src, const Buffer& dst,
        ...
        return enqueueCopyImageToBuffer(
            src, dst, {src_origin[0], src_origin[1], 0},
            {region[0], region[1], 1}, dst_offset, events, event);
    }
    ...
    cl_int enqueueCopyBufferToImage(const Buffer& src, const Image& dst,
        ...
        cl_int err = detail::errHandler(
            CL_(clEnqueueCopyBufferToImage)(
                object_, src(), dst(), src_offset, dst_origin.data(),
                region.data(),
                (events != nullptr) ? (cl_uint)events->size() : 0,
                (events != nullptr && events->size() > 0)
                    ? (const cl_event*)&events->front()
    ...
    cl_int enqueueCopyBufferToImage(const Buffer& src, const Image& dst,
        ...
        return enqueueCopyBufferToImage(
            src, dst, src_offset, {dst_origin[0], dst_origin[1], 0},
            {region[0], region[1], 1}, events, event);
    }
    ...
    void* enqueueMapBuffer(const Buffer& buffer, cl_bool blocking,
        ...
        void* result = CL_(clEnqueueMapBuffer)(
            ...
            (events != nullptr && events->size() > 0)
                ? (const cl_event*)&events->front()
                : nullptr,
            (event != nullptr) ? &tmp : nullptr, &error);
    ...
    void* enqueueMapImage(const Image& image, cl_bool blocking,
                          cl_map_flags flags, const array<size_type, 3>& origin,
                          const array<size_type, 3>& region,
                          size_type* row_pitch, size_type* slice_pitch,
                          const vector<Event>* events = nullptr,
                          Event* event = nullptr, cl_int* err = nullptr) const {
        cl_event tmp;
        cl_int error;
        void* result = CL_(clEnqueueMapImage)(
            object_, image(), blocking, flags, origin.data(), region.data(),
    ...
    void* enqueueMapImage(const Image& image, cl_bool blocking,
                          cl_map_flags flags, const array<size_type, 2>& origin,
                          const array<size_type, 2>& region,
                          size_type* row_pitch, size_type* slice_pitch,
                          const vector<Event>* events = nullptr,
                          Event* event = nullptr, cl_int* err = nullptr) const {
    ...
    /**
     * Enqueues a command that copies a region of memory from the source pointer
     * to the destination pointer. This function is specifically for
     * transferring data between the host and a coarse-grained SVM buffer.
     */
    template <typename T>
    cl_int enqueueMemcpySVM(T* dst_ptr, const T* src_ptr, cl_bool blocking,
                            size_type size,
                            const vector<Event>* events = nullptr,
                            Event* event                = nullptr) const {
        cl_event tmp;
        cl_int err = detail::errHandler(
            CL_(clEnqueueSVMMemcpy)(
                object_, blocking, static_cast<void*>(dst_ptr),
                static_cast<const void*>(src_ptr), size,
                (events != nullptr) ? (cl_uint)events->size() : 0,
                (events != nullptr && events->size() > 0)
                    ? (const cl_event*)&events->front()
                    : nullptr,
    ...
    /**
     *Enqueues a command that will copy data from one coarse-grained SVM buffer
     * to another. This function takes two cl::pointer instances representing
     * the destination and source buffers.
     */
    template <typename T, class D>
    cl_int enqueueMemcpySVM(cl::pointer<T, D>& dst_ptr,
                            const cl::pointer<T, D>& src_ptr, cl_bool blocking,
                            size_type size,
                            const vector<Event>* events = nullptr,
                            Event* event                = nullptr) const {
        cl_event tmp;
        cl_int err = detail::errHandler(
            CL_(clEnqueueSVMMemcpy)(
                object_, blocking, static_cast<void*>(dst_ptr.get()),
                static_cast<const void*>(src_ptr.get()), size,
                (events != nullptr) ? (cl_uint)events->size() : 0,
                (events != nullptr && events->size() > 0)
                    ? (const cl_event*)&events->front()
                    : nullptr,
     ...
     */
    template <typename T, class Alloc>
    cl_int enqueueMemcpySVM(cl::vector<T, Alloc>& dst_container,
    ...
    cl_int enqueueMemFillSVM(T* ptr, PatternType pattern, size_type size,
                             const vector<Event>* events = nullptr,
                             Event* event                = nullptr) const {
        cl_event tmp;
        cl_int err = detail::errHandler(
    ...
    /**
     * Enqueues a command that fills a region of a coarse-grained SVM buffer
     * with a specified pattern. This variant takes a cl::pointer instance.
     */
    template <typename T, class D, typename PatternType>
    cl_int enqueueMemFillSVM(cl::pointer<T, D>& ptr, PatternType pattern,
                             size_type size,
                             const vector<Event>* events = nullptr,
                             Event* event                = nullptr) const {
        cl_event tmp;
        cl_int err = detail::errHandler(
            CL_(clEnqueueSVMMemFill)(
                ...
                static_cast<void*>(&pattern), sizeof(PatternType), size,
                (events != nullptr) ? (cl_uint)events->size() : 0,
                (events != nullptr && events->size() > 0)
                    ? (const cl_event*)&events->front()
                    : nullptr,
    ...
    /**
     * Enqueues a command that will allow the host to fill a region of a
     * coarse-grained SVM buffer with a specified pattern. This variant takes a
     * cl::vector instance.
     */
    template <typename T, class Alloc, typename PatternType>
    cl_int enqueueMemFillSVM(cl::vector<T, Alloc>& container,
                             PatternType pattern,
                             const vector<Event>* events = nullptr,
                             Event* event                = nullptr) const {
        cl_event tmp;
        cl_int err = detail::errHandler(
            CL_(clEnqueueSVMMemFill)(
                ...
                static_cast<void*>(&pattern), sizeof(PatternType),
    ...
    cl_int enqueueMapSVM(T* ptr, cl_bool blocking, cl_map_flags flags,
                         size_type size, const vector<Event>* events = nullptr,
                         Event* event = nullptr) const {
        cl_event tmp;
        cl_int err = detail::errHandler(
            CL_(clEnqueueSVMMap)(
     ...
     */
    template <typename T>
    cl_int enqueueUnmapSVM(T* ptr, const vector<Event>* events = nullptr,
                           Event* event = nullptr) const {
        cl_event tmp;
        cl_int err = detail::errHandler(
            CL_(clEnqueueSVMUnmap)(object_, static_cast<void*>(ptr),
                                   (events != nullptr) ? (cl_uint)events->size()
                                                       : 0,
                                   (events != nullptr && events->size() > 0)
                                       ? (const cl_event*)&events->front()
                                       : nullptr,
    ...
    cl_int enqueueUnmapSVM(cl::pointer<T, D>& ptr,
        ...
        cl_event tmp;
        cl_int err = detail::errHandler(
            CL_(clEnqueueSVMUnmap)(object_, static_cast<void*>(ptr.get()),
                                   (events != nullptr) ? (cl_uint)events->size()
                                                       : 0,
                                   (events != nullptr && events->size() > 0)
                                       ? (const cl_event*)&events->front()
     ...
     * completed.
     */
    cl_int enqueueMarkerWithWaitList(const vector<Event>* events = nullptr,
                                     Event* event = nullptr) const {
        cl_event tmp;
        cl_int err = detail::errHandler(
     ...
     */
    cl_int enqueueBarrierWithWaitList(const vector<Event>* events = nullptr,
                                      Event* event = nullptr) const {
        cl_event tmp;
        cl_int err = detail::errHandler(
    ...
    cl_int enqueueMigrateMemObjects(const vector<Memory>& memObjects,
        ...
        cl_int err = detail::errHandler(
            CL_(clEnqueueMigrateMemObjects)(
                object_, (cl_uint)memObjects.size(), localMemObjects.data(),
                flags, (events != nullptr) ? (cl_uint)events->size() : 0,
                (events != nullptr && events->size() > 0)
                    ? (const cl_event*)&events->front()
                    : nullptr,
                (event != nullptr) ? &tmp : nullptr),
...
#if CL_HPP_TARGET_OPENCL_VERSION >= 210
    /**
     * Enqueues a command that will allow the host associate ranges within a set
     * of SVM allocations with a device.
    ...
    /**
     * Enqueues a command that will allow the host associate a set of SVM
     * allocations with a device.
     */
    template <typename T>
    cl_int enqueueMigrateSVM(const cl::vector<T*>& svmRawPointers,
                             cl_mem_migration_flags flags = 0,
                             const vector<Event>* events  = nullptr,
                             Event* event                 = nullptr) const {
        return enqueueMigrateSVM(svmRawPointers,
                                 cl::vector<size_type>(svmRawPointers.size()),
                                 flags, events, event);
    }
    ...
    cl_int enqueueMigrateSVM(const cl::vector<cl::pointer<T, D>>& svmPointers,
                             ...
                             const vector<Event>* events  = nullptr,
                             Event* event                 = nullptr) const {
        return enqueueMigrateSVM(svmPointers,
                                 cl::vector<size_type>(svmPointers.size()),
                                 flags, events, event);
    }
     ...
     * Enqueues a command that will allow the host associate ranges within a set
     * of SVM allocations with a device.
     * @param sizes - The length from the beginning of each container to
     * migrate.
     */
    template <typename T, class Alloc>
    ...
    template <typename T, class Alloc>
    cl_int
    enqueueMigrateSVM(const cl::vector<cl::vector<T, Alloc>>& svmContainers,
                      cl_mem_migration_flags flags = 0,
                      const vector<Event>* events  = nullptr,
                      Event* event                 = nullptr) const {
        return enqueueMigrateSVM(svmContainers,
                                 cl::vector<size_type>(svmContainers.size()),
                                 flags, events, event);
    }
    ...
    CL_API_PREFIX__VERSION_1_2_DEPRECATED cl_int enqueueTask(
        const Kernel& kernel, const vector<Event>* events = nullptr,
        Event* event = nullptr) const CL_API_SUFFIX__VERSION_1_2_DEPRECATED {
        cl_event tmp;
        cl_int err = detail::errHandler(
            CL_(clEnqueueTask)(object_, kernel(),
                               (events != nullptr) ? (cl_uint)events->size()
                                                   : 0,
                               (events != nullptr && events->size() > 0)
                                   ? (const cl_event*)&events->front()
    ...
    cl_int enqueueNativeKernel(void(CL_CALLBACK* userFptr)(void*),
        ...
        cl_int err = detail::errHandler(
            CL_(clEnqueueNativeKernel)(
                ...
                (mem_objects->size() > 0)
                    ? reinterpret_cast<const cl_mem*>(mem_objects->data())
                    : nullptr,
 ...
 */
    ...
    cl_int enqueueAcquireGLObjects(const vector<Memory>* mem_objects = nullptr,
                                   const vector<Event>* events       = nullptr,
                                   Event* event = nullptr) const {
        cl_event tmp;
        cl_int err = detail::errHandler(
    ...
    cl_int enqueueReleaseGLObjects(const vector<Memory>* mem_objects = nullptr,
                                   const vector<Event>* events       = nullptr,
                                   Event* event = nullptr) const {
        cl_event tmp;
        cl_int err = detail::errHandler(
    ...
    cl_int(CL_API_CALL* PFN_clEnqueueAcquireD3D10ObjectsKHR)(
        cl_command_queue command_queue, cl_uint num_objects,
        const cl_mem* mem_objects, cl_uint num_events_in_wait_list,
        const cl_event* event_wait_list, cl_event* event);
    typedef CL_API_ENTRY
    cl_int(CL_API_CALL* PFN_clEnqueueReleaseD3D10ObjectsKHR)(
        cl_command_queue command_queue, cl_uint num_objects,
        const cl_mem* mem_objects, cl_uint num_events_in_wait_list,
        const cl_event* event_wait_list, cl_event* event);

    cl_int
    enqueueAcquireD3D10Objects(const vector<Memory>* mem_objects = nullptr,
                               const vector<Event>* events       = nullptr,
                               Event* event = nullptr) const {
        static PFN_clEnqueueAcquireD3D10ObjectsKHR
            pfn_clEnqueueAcquireD3D10ObjectsKHR = nullptr;
#if CL_HPP_TARGET_OPENCL_VERSION >= 120
        ...
        cl_int err = detail::errHandler(
            pfn_clEnqueueAcquireD3D10ObjectsKHR(
                ...
                (mem_objects != nullptr && mem_objects->size() > 0)
                    ...
                    : nullptr,
                (events != nullptr) ? (cl_uint)events->size() : 0,
                (events != nullptr) ? (const cl_event*)&events->front()
                                    : nullptr,
                (event != nullptr) ? &tmp : nullptr),
            __ENQUEUE_ACQUIRE_GL_ERR);
    ...
    cl_int
    enqueueReleaseD3D10Objects(const vector<Memory>* mem_objects = nullptr,
                               const vector<Event>* events       = nullptr,
                               Event* event = nullptr) const {
        static PFN_clEnqueueReleaseD3D10ObjectsKHR
            pfn_clEnqueueReleaseD3D10ObjectsKHR = nullptr;
#if CL_HPP_TARGET_OPENCL_VERSION >= 120
        cl_context context = getInfo<CL_QUEUE_CONTEXT>();
        cl::Device device(getInfo<CL_QUEUE_DEVICE>());
        cl_platform_id platform = device.getInfo<CL_DEVICE_PLATFORM>();
 ...
 */
    ...
    cl_int enqueueBarrier() const CL_API_SUFFIX__VERSION_1_1_DEPRECATED {
        return detail::errHandler(CL_(clEnqueueBarrier)(object_),
...
#ifdef cl_khr_external_memory
    cl_int
    enqueueAcquireExternalMemObjects(const vector<Memory>& mem_objects,
                                     const vector<Event>* events_wait = nullptr,
                                     Event* event = nullptr) {
        cl_int err = CL_INVALID_OPERATION;
        cl_event tmp;

        std::call_once(ext_memory_initialized_, initMemoryExtension,
                       this->getInfo<CL_QUEUE_DEVICE>());

        if (pfn_clEnqueueAcquireExternalMemObjectsKHR) {
            err = pfn_clEnqueueAcquireExternalMemObjectsKHR(
                object_, static_cast<cl_uint>(mem_objects.size()),
                (mem_objects.size() > 0)
                    ? reinterpret_cast<const cl_mem*>(mem_objects.data())
                    : nullptr,
                (events_wait != nullptr)
    ...
    cl_int
    enqueueReleaseExternalMemObjects(const vector<Memory>& mem_objects,
                                     const vector<Event>* events_wait = nullptr,
                                     Event* event = nullptr) {
        cl_int err = CL_INVALID_OPERATION;
        cl_event tmp;
...
#ifdef cl_khr_external_memory
CL_HPP_DEFINE_STATIC_MEMBER_ std::once_flag
    CommandQueue::ext_memory_initialized_;
#endif
...
class DeviceCommandQueue : public detail::Wrapper<cl_command_queue> {
  public:
     ...
     */
    DeviceCommandQueue(DeviceQueueProperties properties,
                       cl_int* err = nullptr) {
        cl_int error;
    ...
    /*!
     * Create a device command queue for a specified device in the passed
     * context.
     */
    DeviceCommandQueue(
    ...
    static DeviceCommandQueue makeDefault(cl_int* err = nullptr) {
        ...
        cl_queue_properties queue_properties[] = {CL_QUEUE_PROPERTIES,
                                                  properties, 0};
        DeviceCommandQueue deviceQueue(CL_(clCreateCommandQueueWithProperties)(
            context(), device(), queue_properties, &error));
...
#if CL_HPP_TARGET_OPENCL_VERSION >= 210
    /*!
     * Modify the default device command queue to be used for subsequent
     * kernels. This can update the default command queue for a device
     * repeatedly to account for kernels that rely on the default.
     * @return updated default device command queue.
     */
    static DeviceCommandQueue
    updateDefault(const Context& context, const Device& device,
                  const DeviceCommandQueue& default_queue,
                  cl_int* err = nullptr) {
        cl_int error;
        error = CL_(clSetDefaultDeviceCommandQueue)(context.get(), device.get(),
                                                    default_queue.get());
     ...
     */
    static DeviceCommandQueue getDefault(const CommandQueue& queue,
                                         cl_int* err = nullptr) {
...
Buffer::Buffer(const Context& context, IteratorType startIterator,
    ...
    if (useHostPtr) {
        object_ =
            CL_(clCreateBuffer)(context(), flags, size,
                                const_cast<DataType*>(&*startIterator), &error);
    } else {
        object_ = CL_(clCreateBuffer)(context(), flags, size, 0, &error);
    }
...
inline void* enqueueMapBuffer(const Buffer& buffer, cl_bool blocking,
                              ...
                              size_type size,
                              const vector<Event>* events = nullptr,
                              Event* event = nullptr, cl_int* err = nullptr) {
    cl_int error;
    CommandQueue queue = CommandQueue::getDefault(&error);
    detail::errHandler(error, __ENQUEUE_MAP_BUFFER_ERR);
    if (err != nullptr) {
 ...
 */
template <typename T>
inline cl_int enqueueUnmapSVM(T* ptr, const vector<Event>* events = nullptr,
                              Event* event = nullptr) {
    cl_int error;
    CommandQueue queue = CommandQueue::getDefault(&error);
    if (error != CL_SUCCESS) {
...
inline cl_int enqueueReadBufferRect(
    const Buffer& buffer, cl_bool blocking,
    const array<size_type, 2>& buffer_offset,
    const array<size_type, 2>& host_offset, const array<size_type, 2>& region,
    size_type buffer_row_pitch, size_type buffer_slice_pitch,
    size_type host_row_pitch, size_type host_slice_pitch, void* ptr,
    const vector<Event>* events = nullptr, Event* event = nullptr) {
    return enqueueReadBufferRect(
...
inline cl_int enqueueCopyBufferRect(
    ...
    size_type dst_slice_pitch, const vector<Event>* events = nullptr,
    Event* event = nullptr) {
    cl_int error;
    CommandQueue queue = CommandQueue::getDefault(&error);
...
inline cl_int enqueueCopyBufferRect(
    const Buffer& src, const Buffer& dst, const array<size_type, 2>& src_origin,
    const array<size_type, 2>& dst_origin, const array<size_type, 2>& region,
    size_type src_row_pitch, size_type src_slice_pitch, size_type dst_row_pitch,
    size_type dst_slice_pitch, const vector<Event>* events = nullptr,
    Event* event = nullptr) {
    return enqueueCopyBufferRect(src, dst, {src_origin[0], src_origin[1], 0},
                                 {dst_origin[0], dst_origin[1], 0},
                                 {region[0], region[1], 1}, src_row_pitch,
                                 src_slice_pitch, dst_row_pitch,
                                 dst_slice_pitch, events, event);
}
#endif // CL_HPP_TARGET_OPENCL_VERSION >= 110
...
inline cl_int enqueueReadImage(const Image& image, cl_bool blocking,
                               ...
                               Event* event = nullptr) {
    return enqueueReadImage(image, blocking, {origin[0], origin[1], 0},
                            {region[0], region[1], 1}, row_pitch, slice_pitch,
                            ptr, events, event);
}
...
inline cl_int enqueueCopyImageToBuffer(const Image& src, const Buffer& dst,
                                       ...
                                       const vector<Event>* events = nullptr,
                                       Event* event                = nullptr) {
    return enqueueCopyImageToBuffer(src, dst, {src_origin[0], src_origin[1], 0},
                                    {region[0], region[1], 1}, dst_offset,
                                    events, event);
}
...
inline cl_int enqueueCopyBufferToImage(const Buffer& src, const Image& dst,
    ...
    return enqueueCopyBufferToImage(src, dst, src_offset,
                                    {dst_origin[0], dst_origin[1], 0},
                                    {region[0], region[1], 1}, events, event);
}
...
class EnqueueArgs {
  ...
  public:
    EnqueueArgs(NDRange global)
        : queue_(CommandQueue::getDefault()), offset_(NullRange),
          global_(global), local_(NullRange) {}
    ...
    EnqueueArgs(const vector<Event>& events, NDRange global)
        : queue_(CommandQueue::getDefault()), offset_(NullRange),
          global_(global), local_(NullRange), events_(events) {}

    EnqueueArgs(const vector<Event>& events, NDRange global, NDRange local)
        : queue_(CommandQueue::getDefault()), offset_(NullRange),
          global_(global), local_(local), events_(events) {}
    ...
    EnqueueArgs(CommandQueue& queue, NDRange global)
        : queue_(queue), offset_(NullRange), global_(global),
          local_(NullRange) {}
    ...
    EnqueueArgs(CommandQueue& queue, const vector<Event>& events,
                NDRange global)
...
template <typename... Ts> class KernelFunctor {
  ...
  public:
    ...
    KernelFunctor(const Program& program, const string name,
                  cl_int* err = nullptr)
    ...
    Event operator()(const EnqueueArgs& args, Ts... ts, cl_int& error) {
        ...
        error = args.queue_.enqueueNDRangeKernel(kernel_, args.offset_,
                                                 args.global_, args.local_,
                                                 &args.events_, &event);
...
namespace compatibility {
/**
 * Backward compatibility class to ensure that cl.hpp code works with
 * opencl.hpp. Please use KernelFunctor directly.
 */
template <typename... Ts> struct make_kernel {
    ...
    make_kernel(const Program& program, const string name,
                cl_int* err = nullptr)
...
class Semaphore : public detail::Wrapper<cl_semaphore_khr> {
  public:
    ...
    Semaphore(const vector<cl_semaphore_properties_khr>& sema_props,
              cl_int* err = nullptr)
        : Semaphore(Context::getDefault(err), sema_props, err) {}

    explicit Semaphore(const cl_semaphore_khr& semaphore,
                       bool retainObject = false)
    ...
    typename detail::param_traits<detail::cl_semaphore_info_khr,
                                  name>::param_type
    getInfo(cl_int* err = nullptr) const {
        typename detail::param_traits<detail::cl_semaphore_info_khr,
                                      name>::param_type param;
    ...
    cl_int getHandleForTypeKHR(const Device& device,
                               cl_external_semaphore_handle_type_khr name,
                               T* param) const {
        ...
        return detail::errHandler(
            detail::getInfo(pfn_clGetSemaphoreHandleForTypeKHR, object_,
                            device(), name, param),
            __GET_SEMAPHORE_HANDLE_FOR_TYPE_KHR_ERR);
    }

    template <cl_external_semaphore_handle_type_khr type>
    typename detail::param_traits<detail::cl_external_semaphore_handle_type_khr,
                                  type>::param_type
    getHandleForTypeKHR(const Device& device, cl_int* err = nullptr) const {
        typename detail::param_traits<
            detail::cl_external_semaphore_handle_type_khr, type>::param_type
            param;
  ...
  private:
    ...
    static void initExtensions(const Context& context) {
        ...
        cl_platform_id platform = device.getInfo<CL_DEVICE_PLATFORM>()();
        CL_HPP_INIT_CL_EXT_FCN_PTR_PLATFORM_(
            platform, clCreateSemaphoreWithPropertiesKHR);
        ...
        if ((pfn_clCreateSemaphoreWithPropertiesKHR == nullptr) &&
            ...
            (pfn_clGetSemaphoreInfoKHR == nullptr)) {
            detail::errHandler(CL_INVALID_VALUE,
                               __CREATE_SEMAPHORE_KHR_WITH_PROPERTIES_ERR);
        }
    }
};
...
inline cl_int CommandQueue::enqueueSignalSemaphores(
    const vector<Semaphore>& sema_objects,
    const vector<cl_semaphore_payload_khr>& sema_payloads,
    const vector<Event>* events_wait_list, Event* event) {
    cl_event tmp;
    cl_int err = CL_INVALID_OPERATION;
...
class CommandBufferKhr : public detail::Wrapper<cl_command_buffer_khr> {
  public:
    ...
    cl_int finalizeCommandBuffer() const {
        ...
        return detail::errHandler(pfn_clFinalizeCommandBufferKHR(object_),
                                  __FINALIZE_COMMAND_BUFFER_KHR_ERR);
    }
    ...
    template <int ArrayLength>
    cl_int
    updateMutableCommands(std::array<cl_command_buffer_update_type_khr,
        ...
        return detail::errHandler(
            pfn_clUpdateMutableCommandsKHR(object_,
  ...
  private:
    ...
    static void initExtensions(const cl::Device& device) {
        ...
        if ((pfn_clCreateCommandBufferKHR == nullptr) &&
            ...
            detail::errHandler(CL_INVALID_VALUE,
                               __CREATE_COMMAND_BUFFER_KHR_ERR);
        }
    }
}; // CommandBufferKhr
...
class MutableCommandKhr : public detail::Wrapper<cl_mutable_command_khr> {
  public:
    ...
    explicit MutableCommandKhr(const cl_mutable_command_khr& mutableCommandKhr,
                               bool retainObject = false)
